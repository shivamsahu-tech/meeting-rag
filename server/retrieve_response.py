...
async def retrieve_response_pipeline(
    ...
    # ---- 4️⃣ Extract PDF text + image context ----
    pdf_context = ""
    if pdf_matches:
        extracted_items = []
        ...
        logging.warning("⚠️ No PDF matches found.")

    # ---- 5️⃣ Build prompt and call Gemini ----
    ...
    # ---- 7️⃣ Document OCR search (optional) ----
    if isDocSearchOn:
